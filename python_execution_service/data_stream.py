...
def create_tool_input_available_part(tool_call_id: str, tool_name: str, tool_input: dict[str, Any]) -> dict[str, Any]:
    return {"type": "tool-input-available", "toolCallId": tool_call_id, "toolName": tool_name, "input": tool_input}

...
RETURNS VARCHAR
LANGUAGE SQL
COMMENT = '{ "origin": "sf_sc", "name": "snowconvert", "version": {  "major": 2,  "minor": 6,  "patch": "3-PuPr.6" }, "attributes": {  "component": "oracle",  "convertedOn": "03/13/2026",  "domain": "no-domain-provided",  "migrationid": "qOacAWHnvne4wYlcGVDC4Q==" }}'
EXECUTE AS CALLER
AS
$$
    DECLARE

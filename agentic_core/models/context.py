...
class MigrationContext:
    ...
    self_heal_issues: List[Dict[str, Any]] = field(default_factory=list)
    self_heal_log: List[Dict[str, Any]] = field(default_factory=list)
    ...
    raw_terminal_output_sink: Optional[Callable[[str], None]] = None
